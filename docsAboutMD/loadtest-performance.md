...
항목,결과값,평가
목표 처리량,500 iters/s,실패 (실제 449.44 iters/s)
성공률,"100% (84,750건)",우수 (에러는 없음)
p(95) 응답 시간,1.14s,실패 (기준 500ms 초과)
최대 응답 시간,26.51s,심각 (매우 큰 지연 발생)
가상 사용자(VU),300 (Max 도달),자원 부족 (경고 발생)
